...
extern void arienco_done_encoding(EncodingEnvironmentPtr eep);
...
{
  return (((*eep->Ecodestrm_len) + eep->Epbuf + 1) << 3) + (eep->Echunks_outstanding * 8) + BITS_TO_LOAD - eep->Ebits_to_go;
}
